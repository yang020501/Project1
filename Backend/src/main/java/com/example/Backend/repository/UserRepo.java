...
public interface UserRepo extends JpaRepository<User, Integer> {
    ...
    @Query("SELECT new com.example.Backend.dto.UserDto(p.id, p.username, p.password, p.customer_name, p.phone, " +
    ...
    @Modifying
    @Query(value = "INSERT INTO Users(id, username, password, customer_name, phone, address1, address2, address3) VALUES (?1, ?2, ?3, ?4, ?5, ?6, ?7, ?8)", nativeQuery = true)
